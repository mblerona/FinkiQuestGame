...
#
				...
				#game_ended = true
				#banner.show_banner("🎉 Level 1 Complete!")
...
#
				...
				#if main_node.has_method("switch_to_level2"):
					#main_node.switch_to_level2()
				#else:
					#print("⚠️ Main scene has no method switch_to_level2()")
#
				#return
#
			#await get_tree().create_timer(0.5).timeout
